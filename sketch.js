...
var redB, blueB,arrowB,pinkB,greenB; //creamos las variables para los grupos
...
function setup() {
  ...
  //creamos los grupos, uno para cada globo
...
function redBalloon() {
  ...
  red.lifetime = 150;
  red.scale = 0.1;
  redB.add(red);// asignamos el grupo a los sprites seleccionados
}
...
function blueBalloon() {
  ...
  blue.lifetime = 150;
  blue.scale = 0.1;
  blueB.add(blue); //lo mismo para el globo azul
